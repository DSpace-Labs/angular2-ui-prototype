...
export class SidebarSection implements Hashable, Equatable<SidebarSection> {
    ...
    /**
     * checks to see if we need to run the code for our visible parameter again.
     ...
     * @param child
     */
    addChild(child: SidebarSection): void {
    ...
    constructor(json?: any) {
        // if we have received json input
        if(json) {
            this.id = json.id;
...
class Builder {
     ...
     * @returns {Builder}
     */
    testFunction(code: any): Builder {
        // pass the code for our visibility Observable.
